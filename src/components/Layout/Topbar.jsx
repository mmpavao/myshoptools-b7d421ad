        ...
        <div className="flex items-center space-x-2">
          <div className="relative">
            <Input
              ...
              className="w-48 pl-8 pr-2 py-1 rounded-full bg-gray-200 text-gray-800 placeholder-gray-400 focus:bg-gray-300 transition-colors duration-200 text-sm border-none focus:outline-none"
            />
